...
const Footer = () => {
  ...
  return (
    <div className="absolute left-0 right-0 flex flex-col items-center max-w-full mx-auto space-y-2 text-sm bottom-5 debug text-earth-gray-400">
      <ul className="flex mb-4 space-x-8 2xl:hidden">{icons}</ul>
